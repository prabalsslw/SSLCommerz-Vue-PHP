var vue_det = new Vue({
    ...
    methods: {
       	showdata: function() {
			...
			window.sslczPayBtn('http://localhost:8080/sslcvue/page/request.php',this.tranid(9),{cus_name:this.cus_name , cus_email:this.cus_email , cus_phone:this.cus_phone ,cus_amount:this.cus_amount });
       	},
