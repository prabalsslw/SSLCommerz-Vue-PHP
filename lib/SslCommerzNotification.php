...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function setRequiredInfo(array $info)
    {
        ...
        $this->data['product_category'] = (isset($info['product_category'])) ? $info['product_category'] : null;// string (50)	Mandatory - Mention the product category. It is a open field. Example - clothing,shoes,watches,gift,healthcare, jewellery,top up,toys,baby care,pants,laptop,donation,etc
    ...
    public function setShipmentInfo(array $info)
    {
        ...
        $this->data['num_of_item'] = (isset($info['num_of_item'])) ? $info['num_of_item'] : null; // integer (1)	Mandatory - No of product will be shipped. Example: 1 or 2 or etc
